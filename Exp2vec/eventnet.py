...
class LoadData(object):
    def __init__(self):
        ...
        # self.nodes_num_test = {}
        # self.event_num_test = 0
        # self.event_dict_int_test = {}
        #
        #
        # # self.nodes_num_train = {}
        # self.nodes_num_train = {}
        # self.event_num_train = 0
        # self.event_dict_int_train = {}
    ...
    def load_data(self, filename, event_id_idx):
        ...
        # self.event_num_train=int(self.event_num*0.8)
        # self.event_num_test =self.event_num-self.event_num_train      # all_event_idx = list(range(self.event_num))
        # np.random.shuffle(all_event_idx)
        # train_event_idx = all_event_idx[:self.event_num_train]
        # test_event_idx = all_event_idx[self.event_num_train:]
        # n=0
        # for i in test_event_idx:
        #     self.event_dict_int_test[n] = self.event_dict_int[i]
        #     n=n+1
        # m=0
        # for i in train_event_idx:
        #     self.event_dict_int_train[m] =self.event_dict_int[i]
        #     m=m+1


        # self.nodes_num_train = self.nodes_num
        # self.nodes_num_train['p']=self.event_num_train
        f.close()
